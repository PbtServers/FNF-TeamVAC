...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	MusicianName1 = 'Nullvix ("Friends to your end")'
	MusicianName2 = 'PbtinaDev (Cover)'
	MusicianName3 = ''

	CharterName1 = 'Unknown ("Friends to your end")'
...
function onCreate()
	...
	--CREDITS TEXT
	makeLuaText('CREDITS', 'CREDITOS', 1280, HorizontalWordsOffset, -1000)
	...
	--CODER TEXT
	makeLuaText('CODERS', 'PROGRAMADORES', 1280, HorizontalWordsOffset, -1000)
	...
	--ARTWORK TEXT
	makeLuaText('ARTISTS', 'ARTISTAS', 1280, HorizontalWordsOffset, -1000)
	...
	--MUSIC TEXT
	makeLuaText('MUSICIANS', 'CANCIONES', 1280, HorizontalWordsOffset, -1000)
